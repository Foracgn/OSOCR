from neko_2020nocr.tasks.taskmaker import build_training_dataset_by_label, build_testing_dataset_by_label, \
    split_labelset;
...
def splithwdb_test(trfulldbdst, tefulldbdst, compdbdst, name,
    ...
    # build_testing_dataset_by_label([compdbdst], dstroot, val, eval, ["image"], ["label", "lang", "wrid"], "label",
    # "cuwu_eval","cuwu_val"); build_training_dataset_by_label([compdbdst], dstroot, train, ["image"], ["label",
    # "lang", "wrid"], "label", "cswu_eval");
