...
class HXXOS2C(HXOSC):
    ...
    def setuploss(self):
        ...
        self.wcls = self.cfgs.loss_weight["wcls"]
        self.wsim = self.cfgs.loss_weight["wsim"]
        self.wemb = self.cfgs.loss_weight["wemb"]
        self.wmar = self.cfgs.loss_weight["wmar"]
